...
--sathish 07 Mar 2019
 ALTER TABLE `recency` ADD `sample_collection_date` DATE NOT NULL AFTER `kit_name`, ADD `sample_receipt_date` DATE NOT NULL AFTER `sample_collection_date`, ADD `received_specimen_type` VARCHAR(255) NOT NULL AFTER `sample_receipt_date`;
