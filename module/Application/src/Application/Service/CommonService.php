...
class CommonService {
    ...
    public function getDeliveryTimeSlots(){
        ...
        $deliverySlots=array(
            array(
                $currentDay.'##9:00-AM-to-12:00-PM'=>'Today(9:00 AM to 12:00 PM)',
                $currentDay.'##1:00-PM-to-4:00-PM'=>'Today(1:00 PM to 4:00 PM)',
                $currentDay.'##5:00-PM-to-9:00-PM'=>'Today(5:00 PM to 9:00 PM)'
            ),
            array(
                $currentDay.'##9:00-AM-to-12:00-PM'=>'Today(9:00 AM to 12:00 PM)',
                $currentDay.'##1:00-PM-to-4:00-PM'=>'Today(1:00 PM to 4:00 PM)',
            ...
            array(
                $currentDay.'##1:00-PM-to-4:00-PM'=>'Today(1:00 PM to 4:00 PM)',
                $currentDay.'##5:00-PM-to-9:00-PM'=>'Today(5:00 PM to 9:00 PM)',
                $nextDay.'##9:00-AM-to-12:00-PM'=>'Tomorrow(9:00 AM to 12:00 PM)'
            ),
            array(
                $currentDay.'##1:00-PM-to-4:00-PM'=>'Today(1:00 PM to 4:00 PM)',
                $currentDay.'##5:00-PM-to-9:00-PM'=>'Today(5:00 PM to 9:00 PM)',
            ...
            array(
                $currentDay.'##5:00-PM-to-9:00-PM'=>'Today(5:00 PM to 9:00 PM)',
                $nextDay.'##9:00-AM-to-12:00-PM'=>'Tomorrow(9:00 AM to 12:00 PM)',
                $nextDay.'##1:00-PM-to-4:00-PM'=>'Tomorrow(1:00 PM to 4:00 PM)'
            ),
            array(
                $currentDay.'##5:00-PM-to-9:00-PM'=>'Today(5:00 PM to 9:00 PM)',
                $nextDay.'##9:00-AM-to-12:00-PM'=>'Tomorrow(9:00 AM to 12:00 PM)',
            ...
            array(
                $nextDay.'##9:00-AM-to-12:00-PM'=>'Tomorrow(9:00 AM to 12:00 PM)',
                $nextDay.'##1:00-PM-to-4:00-PM'=>'Tomorrow(1:00 PM to 4:00 PM)',
                $nextDay.'##5:00-PM-to-9:00-PM'=>'Tomorrow(5:00 PM to 9:00 PM)'
            ),
            array(
                $nextDay.'##9:00-AM-to-12:00-PM'=>'Tomorrow(9:00 AM to 12:00 PM)',
                $nextDay.'##1:00-PM-to-4:00-PM'=>'Tomorrow(1:00 PM to 4:00 PM)',
        ...
        return $deliverySlots[$currentHour];
    }
         ...
         public function dbDateTimeFormat($dateTime){
          ...
          public function getRecentData($params)
          {
               $evntDB = $this->sm->get('EventLogTable');
               return $evntDB->getRecentActivities($params);
          }
       ...
       public function updateConfig($params) {
            ...
            $updateRes = $globalDb->updateConfigDetails($params);
               ...
               $eventAction = 'Updated Global Config with the name as - '.ucwords($params['globalName']);
               $resourceName = 'Global Config';
               $eventLogDb = $this->sm->get('EventLogTable');
               $eventLogDb->addEventLog($eventAction, $resourceName);

            $container = new Container('alert');
            $container->alertMsg ="Global Config Updated";
       }
